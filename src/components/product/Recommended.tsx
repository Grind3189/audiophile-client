...
const Recommended = ({ recommendedData, baseUrl, width }: RecommendedProp) => {
  ...
  return (
    <section className="mb-[172px] text-center text-[24px] font-bold">
      ...
      <div className="items-center justify-center xl:justify-between md:flex md:gap-[11px] xl:gap-[30px]">
        {recommendedData.map((product: any) => {
          return (
            <div className="mx-auto flex max-w-[327px] flex-col items-center justify-center gap-8 max-md:mb-[56px] md:mx-0 md:w-[223px] xl:w-[350px]">
              ...
              <Link
                ...
                className="bg-red_orange-200 px-8 py-[15px] text-[13px] tracking-[1px] text-white-100"
              >
                SEE PRODUCT
              </Link>
            </div>
