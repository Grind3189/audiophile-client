          ...
          <Backdrop toggle={handleToggleCart}>
            <div className="mx-au fixed left-[24px] right-[24px] top-[110px] rounded-lg bg-white-100 px-7 py-8 md:absolute md:left-[unset] md:right-[40px] md:top-[20px] md:w-[377px] lg:right-[160px]">
              <div className="mb-[31px] flex items-center justify-between">
                ...
                <button
                  className="text-[15px] font-medium underline decoration-gray-500 opacity-50 lg:hover:text-red_orange-200 lg:hover:decoration-red_orange-200 lg:hover:opacity-100"
                ...
                return (
                    <div className="mb-8 flex items-center gap-4" key={product.id}>
                      ...
                      <div className="ml-auto flex h-[32px] min-w-[96px] items-center justify-between bg-white-300 text-[13px] font-bold">
                        <button
                          className="w-[30%] self-stretch opacity-25 lg:hover:text-red_orange-200 lg:hover:opacity-100"
              ...
              <Link
                to="checkout"
                className="grid place-items-center h-12 w-full bg-red_orange-200 text-[13px] font-bold tracking-[1px] text-white-100 lg:hover:bg-red_orange-100"
